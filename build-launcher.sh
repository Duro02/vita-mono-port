...
arm-vita-eabi-gcc "$ROOT/vita-launcher/main.c" -o "$OUT/launcher.elf" \
	...
	-O2 -Wl,-q -Wl,--wrap=sysconf,--wrap=open,--wrap=close,--wrap=pthread_create,--wrap=write,--wrap=abort,--wrap=raise,--wrap=fcntl,--wrap=getrusage,--wrap=pthread_kill,--wrap=sem_wait,--wrap=sem_timedwait,--wrap=pthread_cond_wait,--wrap=pthread_cond_timedwait \
